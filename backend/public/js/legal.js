    ...
    var T = {
        ...
        procurement: {
            ...
            fa: {
                ...
                buy_h: 'نحوه خرید',
                buy_1: '<strong>ابر شروع — ۴۹ دلار در ماه</strong> — ۱ شعبه، تا ۳ نفر. پرداخت با کریپتو (USDT/BNB/BTC) داخل پنل. اینباکس، تیکت و تسک. ماژول نرخ ارز شامل نیست.',
                ...
                data_3: 'آدرس کیف کریپتو و TXID پرداخت اشتراک — برای فعال‌سازی پنل و حسابرسی',
            ...
            tr: {
                ...
                buy_1: '<strong>Bulut Başlangıç — 49 USD / ay</strong> — 1 şube, en fazla 3 personel. Panelde kripto (USDT/BNB/BTC). Gelen kutusu, talepler, görevler. FX kurları dahil değil.',
                ...
                data_3: 'Kripto cüzdan adresi ve abonelik TXID — panel aktivasyonu ve denetim için',
        ...
        billingSuccess: {
            ...
            fa: {
                h1: 'پرداخت ثبت شد',
                p1: 'متشکریم. FXGuard Cloud Start (۴۹ دلار در ماه، ۱ شعبه، تا ۳ نفر) ثبت شد. برای خرید کریپتو، TXID را داخل پنل ثبت کنید تا قفل برداشته شود.',
                p2: 'اگر TXID را در paywall پنل ثبت کرده‌اید، معمولاً بلافاصله باز می‌شود. داشبورد را رفرش کنید یا دوباره وارد شوید.',
            ...
            tr: {
                h1: 'Ödeme alındı',
                p1: 'Teşekkürler. FXGuard Cloud Start (49 USD/ay, 1 şube, en fazla 3 personel) kaydedildi. Kripto ödemede TXID’yi panelde gönderin; kilit kalkar.',
                p2: 'TXID’yi panel paywall’undan gönderdiyseniz genelde hemen açılır. Paneli yenileyin veya tekrar giriş yapın.',
