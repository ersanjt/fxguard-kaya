/**
 * Default departments for exchange — created on first run or when only support exists
 */
...
const DEFAULT_DEPARTMENTS = [
    {
        name: 'حواله و انتقال',
        description:
            'حواله ارز، وایر، انتقال به امارات، ترکیه، اروپا و سایر کشورها',
        keywords:
            'حواله,حواله ای,وایر,انتقال,دلار,یورو,درهم,لیر,امارات,ترکیه,دبی,قیمت حواله,مبلغ حواله,swift,سوئیفت,انتقال وجه,انتقال ارز',
        color: '#10b981',
        isDefault: false,
    },
    {
        ...
        keywords:
            'خرید,فروش,ارز,دلار,یورو,درهم,لیر,پوند,قیمت,نرخ,نرخ لحظه,تبدیل,تعویض,مبادله,صرافی,نقدی,چند,چقدر',
        color: '#3b82f6',
        isDefault: false,
    },
    {
        ...
        keywords:
            'پشتیبانی,مشکل,راهنما,سوال,شکایت,کمک,راهنمایی,مشکلی,ایراد,خطا,چطور,چگونه,وضعیت,پیگیری',
        color: '#3498db',
        isDefault: true,
    },
];
