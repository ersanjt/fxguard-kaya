(function() {
    ...
    var TRANSLATIONS = {
        en: {
            ...
            hero_a1: 'Sales teams', hero_a2: 'Shops &amp; retail', hero_a3: 'Clinics &amp; doctors',
            hero_a4: 'Companies &amp; branches', hero_a5: 'Exchange &amp; remittance', hero_a6: 'Any business we tailor',
            ...
            svc7_title: 'Data handling (DPA on request)', svc7_desc: 'Access control, minimization and activity logs. A GDPR DPA is discussed on the Europe page and with EU buyers — this homepage does not claim a certificate.',
        ...
        fa: {
            ...
            hero_a1: 'تیم‌های فروش', hero_a2: 'فروشگاه و خرده‌فروشی', hero_a3: 'مطب و کلینیک',
            hero_a4: 'شرکت و چندشعبه', hero_a5: 'صرافی و حواله', hero_a6: 'هر کسب‌وکاری که برایتان اختصاصی شود',
            ...
            svc7_title: 'داده (DPA درخواستی)', svc7_desc: 'کنترل دسترسی، کمینه‌سازی و لاگ فعالیت. DPA مربوط به GDPR در صفحه اروپا و با خریدار اروپایی مطرح می‌شود — این صفحه گواهی ادعا نمی‌کند.',
        ...
        tr: {
            ...
            hero_badge: 'Satış ekipleri, dükkanlar, klinikler, şirketler — işinize göre özelleştirilir',
            hero_title: 'WhatsApp\'ı <span>Satış Makinesine</span> Çevirin',
            ...
            svc7_title: 'Veri (DPA talep üzerine)', svc7_desc: 'Erişim kontrolü, minimizasyon ve aktivite logları. GDPR DPA Avrupa sayfasında ve AB alıcılarıyla konuşulur — bu ana sayfa sertifika iddia etmez.',
        ...
        ar: {
            ...
            hero_badge: 'فرق مبيعات ومتاجر وعيادات وشركات — يُخصَّص لعملك',
            hero_title: 'حوّل واتساب إلى <span>آلة مبيعات</span>',
            ...
            svc7_title: 'البيانات (DPA عند الطلب)',
            svc7_desc: 'ضبط الوصول والتقليل وسجلات النشاط. اتفاقية GDPR تُناقش في صفحة أوروبا ومع المشترين الأوروبيين — هذه الصفحة لا تدّعي شهادة.',
        ...
        ru: {
            ...
            hero_badge: 'Отделы продаж, магазины, клиники, компании — под ваш бизнес',
            hero_title: 'Превратите WhatsApp в <span>машину продаж</span>',
            ...
            svc7_title: 'Данные (DPA по запросу)',
            svc7_desc: 'Контроль доступа, минимизация и журналы. GDPR DPA — на европейской странице и с покупателями ЕС. Эта главная сертификат не заявляет.',
