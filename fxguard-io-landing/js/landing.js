(function() {
    ...
    var TRANSLATIONS = {
        en: {
            ...
            hero_cta_demo: 'See demo', hero_cta_signup: 'Start 7-day trial', hero_cta_packages: 'Prices', hero_cta_wa: 'Talk on WhatsApp',
        ...
        fa: {
            ...
            hero_title: 'نرخ را در واتساپ بگویید. پرونده مشتری مال <span>شرکت</span> بماند.',
            ...
            hero_cta_demo: 'مشاهده دمو', hero_cta_signup: '۷ روز رایگان', hero_cta_packages: 'قیمت‌ها', hero_cta_wa: 'گفتگو در واتساپ',
            hero_who_label: 'مناسب برای',
            hero_a1: 'صرافی',             hero_a2: 'دفاتر حواله', hero_a3: 'خدمات مالی',
            hero_a4: 'شعبه‌های چندگانه', hero_a5: 'تیم‌های دیگر — هسته بدون نرخ', hero_a6: 'پنل را اختصاصی می‌کنیم',
        ...
        tr: {
            ...
            hero_cta_demo: 'Ücretsiz Demo', hero_cta_signup: '7 gün ücretsiz', hero_cta_packages: 'Fiyat & Satın Al', hero_cta_wa: 'WhatsApp\'tan Al',
        ...
        ru: {
            ...
            hero_cta_signup: '7 дней бесплатно',
    ...
    function updateSeoMeta(lang) {
        ...
        var FOOTER_I18N = {"en": {"footer_about": "FXGuard is a WhatsApp CRM: one company number, a shared team panel, customer history stays with the business. We customize it for your trade.", "footer_who": "For exchange offices, remittance desks and finance firms — Cloud Start works without the FX pack.", "footer_trust": "AI-assisted engineering · optional smart replies · 7-day money-back on first Cloud Start month", "footer_markets": "Turkey · UAE · Europe · Iran", "footer_col_product": "Products", "footer_col_solutions": "Solutions", "footer_col_company": "Company", "footer_whatsapp_crm": "WhatsApp CRM", "footer_pricing": "Pricing &amp; Packages", "footer_self_hosted": "Self-hosted License", "footer_managed": "Managed Hosting", "footer_open_panel": "Staff login", "footer_updates": "System Updates", "footer_blog": "Blog &amp; Articles", "footer_tagline": "WhatsApp CRM — tailored to your business", "footer_demo": "Demo"}, "fa": {"footer_about": "FXGuard یک CRM واتساپ برای صرافی، حواله و خدمات مالی است: یک شماره سازمانی، نرخ ارز روی همان پنل چت، پرونده مشتری مال شرکت می‌ماند.", "footer_who": "مخاطب اصلی: صرافی، حواله، خدمات مالی. تیم‌های دیگر می‌توانند Cloud Start را بدون بستهٔ نرخ بگیرند.", "footer_trust": "پاسخ اول اختیاری با OpenAI (کلید مال شما) · معامله را کارشناس می‌بندد · بازگشت وجه ۷روزه ماه اول Cloud Start", "footer_markets": "ترکیه · امارات · اروپا · ایران", "footer_col_product": "محصولات", "footer_col_solutions": "راه‌حل‌ها", "footer_col_company": "شرکت", "footer_whatsapp_crm": "CRM واتساپ", "footer_pricing": "قیمت و بسته‌ها", "footer_self_hosted": "مجوز نصب روی سرور شما", "footer_managed": "اداره توسط ما", "footer_open_panel": "ورود کارکنان", "footer_updates": "به‌روزرسانی سیستم", "footer_blog": "وبلاگ و مقالات", "footer_tagline": "CRM واتساپ برای صرافی و خدمات مالی", "footer_demo": "دمو"}, "tr": {"footer_about": "FXGuard, döviz bürosu, havale ve finans için bir WhatsApp CRM’dir: şirket numarası, sohbetle aynı panelde kur, müşteri kaydı işletmede kalır.", "footer_who": "Birincil: döviz, havale, finans. Diğer ekipler kur paketi olmadan Cloud Start kullanabilir.", "footer_trust": "İsteğe bağlı ilk yanıtlar (OpenAI anahtarınız) · kuru personel kapatır · ilk Cloud Start ayında 7 gün iade", "footer_markets": "Türkiye · BAE · Avrupa · İran", "footer_col_product": "Ürünler", "footer_col_solutions": "Çözümler", "footer_col_company": "Şirket", "footer_whatsapp_crm": "WhatsApp CRM", "footer_pricing": "Fiyat &amp; Paketler", "footer_self_hosted": "Kendi sunucunuzda lisans", "footer_managed": "Özel kurulum", "footer_open_panel": "Personel girişi", "footer_updates": "Sistem Güncellemeleri", "footer_blog": "Blog &amp; Yazılar", "footer_tagline": "Döviz ve finans ekipleri için WhatsApp CRM", "footer_demo": "Demo"}, "ar": {"footer_about": "FXGuard نظام CRM واتساب لمكاتب الصرافة والحوالات والخدمات المالية: رقم للشركة، أسعار على لوحة الدردشة نفسها، ملف العملاء يبقى للعمل.", "footer_who": "الجمهور الأساسي: الصرافة والحوالات والخدمات المالية. الفرق الأخرى تستخدم Cloud Start بلا حزمة الأسعار.", "footer_trust": "ردود أولى اختيارية بمفتاح OpenAI · يغلق الصفقة الموظف · استرداد 7 أيام لأول شهر Cloud Start", "footer_markets": "تركيا · الإمارات · أوروبا · إيران", "footer_col_product": "المنتجات", "footer_col_solutions": "الحلول", "footer_col_company": "الشركة", "footer_whatsapp_crm": "CRM واتساب", "footer_pricing": "الأسعار والباقات", "footer_self_hosted": "ترخيص على خوادمكم", "footer_managed": "تشغيل مخصص", "footer_open_panel": "دخول الموظفين", "footer_updates": "تحديثات النظام", "footer_blog": "المدونة والمقالات", "footer_tagline": "CRM واتساب لمكاتب الصرافة والخدمات المالية", "footer_demo": "عرض توضيحي"}, "ru": {"footer_about": "FXGuard — WhatsApp CRM для обменных пунктов, переводов и финансов: один корпоративный номер, курсы на той же панели, что чат, база клиентов остаётся в компании.", "footer_who": "Основное: обмен, переводы, финансы. Другие команды могут взять Cloud Start без пакета курсов.", "footer_trust": "Опциональные первые ответы (ваш ключ OpenAI) · сделку закрывает сотрудник · 7 дней возврата за первый месяц Cloud Start", "footer_markets": "Турция · ОАЭ · Европа · Иран", "footer_col_product": "Продукты", "footer_col_solutions": "Решения", "footer_col_company": "Компания", "footer_whatsapp_crm": "WhatsApp CRM", "footer_pricing": "Цены и пакеты", "footer_self_hosted": "Self-hosted лицензия", "footer_managed": "Managed-хостинг", "footer_open_panel": "Вход сотрудников", "footer_updates": "Обновления системы", "footer_blog": "Блог и статьи", "footer_tagline": "WhatsApp CRM для обмена и финансов", "footer_demo": "Демо"}};
